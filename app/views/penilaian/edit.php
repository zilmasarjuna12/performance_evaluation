<form class="form-penilaian" action="<?= BASEURL; ?>/penilaian/edit" method="POST">
  <div class="modal-header">
    <h4 class="modal-title" id="standard-modalLabel">Edit penilaian</h4>
    ...
    <ol class="list-group list-group-numbered">
        ...
        <div class="ms-2 me-auto">
          ...
          <div class="mt-2">
            <div class="form-floating">
              <textarea class="form-control" name="delivery_time_comment" placeholder="Leave a comment here" id="edit_delivery_comment" style="height: 100px;"></textarea>
      ...
      <li class="mb-2 d-flex justify-content-between">
        <div class="ms-2 me-auto">
          ...
          <div class="mt-2">
            <div class="form-floating">
              <textarea class="form-control" name="execution_comment" placeholder="Leave a comment here" id="edit_execution_comment" style="height: 100px;"></textarea>
              <label for="floatingTextarea">Komentar</label>
            </div>
          </div>
        </div>
      ...
      <li class="mb-2 d-flex justify-content-between">
        <div class="ms-2 me-auto">
          ...
          <div class="mt-2">
            <div class="form-floating">
              <textarea class="form-control" name="team_work_comment" placeholder="Leave a comment here" id="edit_team_work_comment" style="height: 100px;"></textarea>
              <label for="floatingTextarea">Komentar</label>
            </div>
          </div>
        </div>
      ...
      <li class="mb-2 d-flex justify-content-between">
        <div class="ms-2 me-auto">
          ...
          <div class="mt-2">
            <div class="form-floating">
              <textarea class="form-control" name="innovation_comment" placeholder="Leave a comment here" id="edit_innovation_comment" style="height: 100px;"></textarea>
              <label for="floatingTextarea">Komentar</label>
            </div>
          </div>
        </div>

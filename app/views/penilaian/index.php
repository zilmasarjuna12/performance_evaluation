            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Form penilaian (<?= $data['periode']['name'] ?>)</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                          <form action="<?= BASEURL; ?>/penilaian/add" method="POST">
                            <div class="col-12">
                              <div class="card">
                                <div class="card-body">
                                  ...
                                  <ol class="list-group list-group-numbered">
                                      ...
                                      <div class="ms-2 me-auto">
                                        ...
                                        <div class="mt-2">
                                          ...
                                          <div class="form-check">
                                              ...
                                              <label class="form-check-label" for="delivery_time2">4</label>
                                          </div>
                                          <div class="form-check">
                                        ...
                                        <div class="mt-2">
                                          <div class="form-floating">
                                            <textarea class="form-control" name="delivery_time_comment" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                                    ...
                                    <li class="mb-2 d-flex justify-content-between">
                                      <div class="ms-2 me-auto">
                                        ...
                                        <div class="mt-2">
                                          <div class="form-floating">
                                            <textarea class="form-control" name="execution_comment" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                                            <label for="floatingTextarea">Komentar</label>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <li class="mb-2 d-flex justify-content-between">
                                      <div class="ms-2 me-auto">
                                        ...
                                        <div class="mt-2">
                                          <div class="form-floating">
                                            <textarea class="form-control" name="team_work_comment" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                                            <label for="floatingTextarea">Komentar</label>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <li class="mb-2 d-flex justify-content-between">
                                      <div class="ms-2 me-auto">
                                        ...
                                        <div class="mt-2">
                                          <div class="form-floating">
                                            <textarea class="form-control" name="innovation_comment" placeholder="Leave a comment here" id="floatingTextarea" style="height: 100px;"></textarea>
                                            <label for="floatingTextarea">Komentar</label>
                                          </div>
                                        </div>
                                      </div>
